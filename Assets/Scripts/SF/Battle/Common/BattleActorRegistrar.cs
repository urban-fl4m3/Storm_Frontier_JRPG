...
{
    public class BattleActorRegistrar : ActorRegistrar<BattleActor>, IBattleActorsHolder
    {
        public BattleActor ActingActor { get; set; }
        ...
        private IEnumerable<BattleActor> _actingActors1;
